...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypdb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6638&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypdb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypdb` can be installed with:

```
conda install pypdb
```

It is possible to list all of the versions of `pypdb` available on your platform with:
